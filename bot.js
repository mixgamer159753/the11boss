...
القسم الثالث مصمم البوت | @SC | MCD% Mix gamer#4819   
...
القسم الثالث مصمم البوت | @SC | MCD% Mix gamer
...
const client = new Discord.Client();
client.on('ready', () => {
  client.user.setGame(`on 0 servers | *help | By !SCIHuler!MIXGAMER!HulerISC#4819  .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
